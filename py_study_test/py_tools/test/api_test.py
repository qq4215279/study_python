...
class Task(threading.Thread):
    ...
    # 注册
    def __register(self):
        receive_dict = self.client.send_msg_and_receive("ReqRegisterTourist", ["test_baloot", config_dict["version"], "test22"])[0][1]
...
if __name__ == '__main__':
    ...
    # 获取功能状态  funcId
    # task.add_command("ReqFunctionStatus", [740000])

    # 请求给我发放一些道具
    # task.send_msg_and_receive("ReqGiveMeItems", [{"6201": 1000000}, helper.KEY, 11569])
    ...
    # 摇钱树抽奖
    # task.send_msg_and_receive("ReqPrizePoolReward", [630000, 10])
    ...
    # task.add_command("ReqDrawAmmunitionReward", [2, 1])
    ...
    # ss = task.send_msg_and_receive("ReqGetSummerTourInfo", [])
    # print(ss)
